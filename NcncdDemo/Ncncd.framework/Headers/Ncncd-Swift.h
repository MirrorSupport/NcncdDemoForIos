...
///
+ (void)initConfigureWithAppKey:(NSString * _Nonnull)appKey appSecret:(NSString * _Nonnull)appSecret httpApi:(NSString * _Nonnull)httpApi deviceNo:(NSString * _Nonnull)deviceNo SWIFT_METHOD_FAMILY(none);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
